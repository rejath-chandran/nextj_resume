...
export default function Stepper({
  ...
  return (
    ...
    >
      ...
      >
        <div className={`${stepContainerClassName} flex w-full items-center py-6 px-4`}>
          ...
          <div className={`px-4 pb-6 ${footerClassName}`}>
            <div className={`mt-8 flex ${currentStep !== 1 ? 'justify-between' : 'justify-end'}`}>
              ...
              <button
                ...
                className="duration-350 flex items-center justify-center rounded-full py-2.5 px-6 font-medium tracking-tight text-white transition"
                {...nextButtonProps}
              >
...
function StepIndicator({ step, currentStep, onClickStep, disableStepIndicators = false }: StepIndicatorProps) {
  ...
  return (
    ...
    >
      <motion.div
        variants={{
          inactive: { scale: 1, backgroundColor: '#d4d4d4', color: '#737373' },
          active: { scale: 1.1, backgroundColor: '#8B5CF6', color: '#fff' },
          complete: { scale: 1, backgroundColor: '#7c3aed', color: '#fff' }
        }}
...
function StepConnector({ isComplete }: StepConnectorProps) {
  ...
  return (
    <div className="relative mx-3 h-1 flex-1 overflow-hidden rounded-full bg-neutral-200">
      <motion.div
